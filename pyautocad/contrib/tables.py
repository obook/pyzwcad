...
import tablib
import xlrd
import pyzwcad.contrib.tables

FormatNotSupported = pyzwcad.contrib.tables.FormatNotSupported
# class FormatNotSupported(Exception):
#     pass



Table = pyzwcad.contrib.tables.Table
...
_TableImporter = pyzwcad.contrib.tables._TableImporter
